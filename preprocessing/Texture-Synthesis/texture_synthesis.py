...
parser.add_argument("-o", "--output", required=True, type=str, help="output_path")
...
if __name__ == "__main__":
    ...
    # block size calculated instead passed in args
    block_size = min(img.shape[0]//10*10 - 5, img.shape[1]//10*10 -5)
    num_block = args.num_block
    mode = args.mode
    img = quilt(image_path, block_size, (num_block, num_block), mode)
